...
import io.festoso.rpgvault.domain.pf2api.AncestryResponse;
...
public class AncestryDefinitions extends CucumberTest {
    ...
    private static final String ENDPOINT_VARIABLE_NAME = "ancestryEndpointUrl";
    private static final String ENDPOINT_PATH = "/v1/pf2/ancestry";
    private static final String ENDPOINT_VARIABLE_VALUE = "http://localhost:" + WIREMOCK_PORT + ENDPOINT_PATH;
    private static final String PATH_TO_EXPECTED_FILE = "src/test/resources/json/pf2e-api-ancestry-response.json";
    ...
    public void verifyAllAncestries() throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        AncestryResponse expected = mapper.readValue(new File(PATH_TO_EXPECTED_FILE), AncestryResponse.class);
