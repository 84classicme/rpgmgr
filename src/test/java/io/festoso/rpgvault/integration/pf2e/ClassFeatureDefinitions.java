...
import io.festoso.rpgvault.domain.pf2api.ClassFeatureResponse;
...
public class ClassFeatureDefinitions extends CucumberTest {
    ...
    private static final String ENDPOINT_VARIABLE_NAME = "classFeatureEndpointUrl";
    private static final String ENDPOINT_PATH = "/v1/pf2/classFeature";
    private static final String ENDPOINT_VARIABLE_VALUE = "http://localhost:" + WIREMOCK_PORT + ENDPOINT_PATH;
    private static final String PATH_TO_EXPECTED_FILE = "src/test/resources/json/pf2e-api-classFeature-response.json";
    ...
    public void verifyAllClassFeatures() throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        ClassFeatureResponse expected = mapper.readValue(new File(PATH_TO_EXPECTED_FILE), ClassFeatureResponse.class);
