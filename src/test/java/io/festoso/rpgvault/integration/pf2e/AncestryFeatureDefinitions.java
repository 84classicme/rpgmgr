...
import io.festoso.rpgvault.domain.pf2api.AncestryFeatureResponse;
...
public class AncestryFeatureDefinitions extends CucumberTest {
    ...
    private static final String ENDPOINT_VARIABLE_NAME = "ancestryFeatureEndpointUrl";
    private static final String ENDPOINT_PATH = "/v1/pf2/ancestryFeature";
    private static final String ENDPOINT_VARIABLE_VALUE = "http://localhost:" + WIREMOCK_PORT + ENDPOINT_PATH;
    private static final String PATH_TO_EXPECTED_FILE = "src/test/resources/json/pf2e-api-ancestryFeature-response.json";
    ...
    public void verifyAllAncestryFeatures() throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        AncestryFeatureResponse expected = mapper.readValue(new File(PATH_TO_EXPECTED_FILE), AncestryFeatureResponse.class);
