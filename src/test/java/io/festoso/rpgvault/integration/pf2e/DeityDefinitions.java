...
import io.festoso.rpgvault.domain.pf2api.DeityResponse;
...
public class DeityDefinitions extends CucumberTest {
    ...
    private static final String ENDPOINT_VARIABLE_NAME = "deityEndpointUrl";
    private static final String ENDPOINT_PATH = "/v1/pf2/deity";
    private static final String ENDPOINT_VARIABLE_VALUE = "http://localhost:" + WIREMOCK_PORT + ENDPOINT_PATH;
    private static final String PATH_TO_EXPECTED_FILE = "src/test/resources/json/pf2e-api-deity-response.json";
    ...
    public void verifyAllDeities() throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        DeityResponse expected = mapper.readValue(new File(PATH_TO_EXPECTED_FILE), DeityResponse.class);
