...
import io.festoso.rpgvault.domain.pf2api.ArchetypeResponse;
...
public class ArchetypeDefinitions extends CucumberTest {
    ...
    private static final String ENDPOINT_VARIABLE_NAME = "archetypeEndpointUrl";
    private static final String ENDPOINT_PATH = "/v1/pf2/archetype";
    private static final String ENDPOINT_VARIABLE_VALUE = "http://localhost:" + WIREMOCK_PORT + ENDPOINT_PATH;
    private static final String PATH_TO_EXPECTED_FILE = "src/test/resources/json/pf2e-api-archetype-response.json";
    ...
    public void verifyAllArchetypes() throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        ArchetypeResponse expected = mapper.readValue(new File(PATH_TO_EXPECTED_FILE), ArchetypeResponse.class);
