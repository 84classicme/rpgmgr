...
import io.festoso.rpgvault.domain.pf2api.EquipmentResponse;
...
public class EquipmentDefinitions extends CucumberTest {
    ...
    private static final String ENDPOINT_VARIABLE_NAME = "equipmentEndpointUrl";
    private static final String ENDPOINT_PATH = "/v1/pf2/equipment";
    private static final String ENDPOINT_VARIABLE_VALUE = "http://localhost:" + WIREMOCK_PORT + ENDPOINT_PATH;
    private static final String PATH_TO_EXPECTED_FILE = "src/test/resources/json/pf2e-api-equipment-response.json";
    ...
    public void verifyAllEquipment() throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        EquipmentResponse expected = mapper.readValue(new File(PATH_TO_EXPECTED_FILE), EquipmentResponse.class);
